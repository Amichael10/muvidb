...
export default function Login() {
  ...
  useEffect(() => {
    document.title = "FilmDba | Sign In";
  }, []);
    ...
    <AuthLayout>
      <div className="mb-8">
        ...
        <p className="text-text-muted">
          Sign in to your FilmDba account
        </p>
      </div>
      ...
      <button
        ...
        className="w-full bg-white text-bg font-bold py-3.5 rounded-xl flex items-center justify-center gap-3 hover:bg-white/90 active:scale-95 transition-all duration-300 min-h-[44px]"
      >
