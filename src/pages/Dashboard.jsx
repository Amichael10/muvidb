                      ...
                      {reviews.map(review => (
                        <div key={review.id} className="bg-surface p-8 rounded-xl border border-border space-y-6 relative overflow-hidden">
                          ...
                          <div className="flex gap-8 relative z-10">
                            <Link to={`/films/${review.film.slug || review.film.id}`} className="shrink-0 w-24 aspect-[2/3] rounded-lg overflow-hidden border border-border shadow-md">
                            ...
                            <div className="flex-1 space-y-4">
                              <div className="flex justify-between items-start">
                                <div>
                                  <Link to={`/films/${review.film.slug || review.film.id}`} className="font-bold text-text-primary hover:text-brand transition-colors text-lg tracking-tight">
                                    {review.film.title}
                                  </Link>
