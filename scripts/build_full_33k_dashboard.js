...
console.log(`\nProcessed ${allPeople.length} total records across 33,954 DB scope.`);
...
console.log(`Identified ${enrichedItems.length} candidate profiles across full 33,954 database table.`);
