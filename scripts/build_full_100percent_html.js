...
console.log(`Loaded ${allRecords.length} records from scanned DB pages.`);
...
console.log(`Generated ${enrichedItems.length} total enriched profile records.`);
...
console.log(`Updated dashboard with ${enrichedItems.length} records.`);
