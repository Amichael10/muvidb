...
-- 3. FOLLOWS POLICIES
-- =====================================================================
-- Follower relationships are non-sensitive and the app shows public follower
-- counts (useFollow.js counts rows by person_id across all users), so reads
-- are public. Writes below remain restricted to the owning user.
