/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: add5d7eec19a4012388b4b65faf2750d)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_APP_URL" | "ENGINE_ENV">> {}
}
